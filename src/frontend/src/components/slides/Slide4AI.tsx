    ...
    <div className="flex-1 flex flex-col p-12 md:p-16 bg-gradient-to-br from-black via-slate-950 to-black">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="space-y-4">
          <div className="bg-black/60 p-5 rounded-sm border border-silver/20">
      ...
      {/* Bottom Highlight */}
      <div className="p-5 bg-gold/10 border border-gold/30 rounded-sm flex items-center justify-center gap-3">

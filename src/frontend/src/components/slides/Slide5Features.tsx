        ...
        <div className="space-y-6">
          <div className="bg-black/40 p-6 rounded-sm border border-gold/30">
            ...
            <div className="space-y-5">
              <div className="p-5 bg-black/60 rounded-sm border border-silver/20">
          ...
          <div className="p-5 bg-gold/5 rounded-sm border border-gold/30">
            <p className="text-silver/90 font-medium text-sm text-center tracking-wide">
